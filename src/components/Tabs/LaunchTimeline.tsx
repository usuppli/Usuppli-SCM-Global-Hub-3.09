...
const LaunchTimeline: React.FC<Props> = ({ lang, product, onSave, isReadOnly }) => {
  ...
  const [phases, setPhases] = useState([
    { id: 1, key: 'p1', date: 'Q1 2026', market: t.phases.p1.market, activity: t.phases.p1.activity },
    { id: 2, key: 'p2', date: 'Q2 2026', market: t.phases.p2.market, activity: t.phases.p2.activity },
    { id: 3, key: 'p3', date: 'Q3 2026', market: t.phases.p3.market, activity: t.phases.p3.activity },
    { id: 4, key: 'p4', date: 'Q4 2026', market: t.phases.p4.market, activity: t.phases.p4.activity },
    { id: 5, key: 'p5', date: 'Q1 2027', market: t.phases.p5.market, activity: t.phases.p5.activity },
  ]);
  ...
  return (
    <div className="space-y-6 animate-in fade-in">
        <div id="timeline-card" className={getCardClassName()} onClick={() => !isEditing && !isReadOnly && setIsEditing(true)}>
            ...
            <h3 className="font-bold text-slate-800 dark:text-white mb-1">{t.title}</h3>
